...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/img-7.png" style="aspect-ratio:9/16;object-fit:contain;width:auto;height:800px"/></figure>
<!-- /wp:image -->

</div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"50%","style":{"spacing":{"blockGap":"var:preset|spacing|60"}}} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
<!-- wp:pattern {"slug":"patterns-kindergarten/section-title-3"} /-->
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|60"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group">
	
<!-- wp:pattern {"slug":"patterns-kindergarten/card-4"} /-->
...
<h5 class="wp-block-heading has-text-align-left has-secondary-color has-text-color" style="margin-bottom:0px;font-size:1.5rem;font-style:normal;font-weight:700;line-height:1"><?php esc_html_e( 'Outdoor Games', 'patterns-kindergarten' ); ?></h5>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"15px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":5,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","lineHeight":"1","fontSize":"1.5rem"},"spacing":{"margin":{"bottom":"0px"}}},"textColor":"secondary"} -->
<h5 class="wp-block-heading has-text-align-left has-secondary-color has-text-color" style="margin-bottom:0px;font-size:1.5rem;font-style:normal;font-weight:700;line-height:1"><?php esc_html_e( 'Nutritious Food', 'patterns-kindergarten' ); ?></h5>
<!-- /wp:heading -->
