...
/**
 * Title: Post Meta
 * Slug: patterns-kindergarten/post-meta
 * Categories: posts
...
<p class="has-quaternary-color has-text-color" style="margin-bottom:0px"><?php esc_html_e( 'Posted :', 'patterns-kindergarten' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="font-size:14px"><!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"0px"}}},"textColor":"quaternary"} -->
<p class="has-quaternary-color has-text-color" style="margin-bottom:0px"><?php esc_html_e( 'by :', 'patterns-kindergarten' ); ?></p>
<!-- /wp:paragraph -->
