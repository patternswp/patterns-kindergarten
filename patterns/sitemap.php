...
/**
 * Title: Page Sitemap
 * Slug: patterns-kindergarten/page-sitemap
 * Post Types: page
...
<div class="wp-block-columns alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Pages', 'patterns-kindergarten' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Categories', 'patterns-kindergarten' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Posts', 'patterns-kindergarten' ); ?></h4>
			<!-- /wp:heading -->
