...
/**
 * Title:404
 * Slug: patterns-kindergarten/hidden-404
 * Inserter: no
 *
...
<h1 class="wp-block-heading alignwide has-text-align-left" style="font-size:8rem"><?php esc_html_e( 'Ooops!', 'patterns-kindergarten' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"bottom":"15px"}}},"fontSize":"large"} -->
<p class="has-text-align-left has-large-font-size" style="margin-bottom:15px"><?php esc_html_e( 'This page could not be found.', 'patterns-kindergarten' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}},"fontSize":"small"} -->
<p class="has-text-align-left has-small-font-size" style="margin-bottom:var(--wp--preset--spacing--30)"><?php esc_html_e( 'We can\'t find the page you\'re looking for. Check out our Help Center or head back to home', 'patterns-kindergarten' ); ?>
</p>
<!-- /wp:paragraph -->
