 ...
 * @subpackage Patterns_Kindergarten/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Kindergarten_Api' ) ) {

	/**
	 * Patterns_Kindergarten_Api
	 *
	 * @package Patterns_Kindergarten
	 * @since 1.0.1
	 */
	class Patterns_Kindergarten_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-kindergarten' ), '1.0.0' );
		}
